...
export const LESSONS: readonly Lesson[] = [
  {
    ...
    focus: ['E', 'T'],
    items: [
      { text: 'E', gloss: 'E：点一下就行', note: '又快又干脆，手指一碰就松' },
      { text: 'T', gloss: 'T：按住，长度是点的三倍', note: '是“按久一点”，不是“用力按住”' },
      { text: 'TE', gloss: 'TE：一个划接一个点' },
      { text: 'ET', gloss: 'ET：反过来再来一遍' },
      { text: 'TEE', gloss: 'TEE：划、点、点' },
      { text: 'TEET', gloss: 'TEET：两样混着来' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'PSE QRS = UR QSB = AGN PSE', gloss: '请慢点，你的信号在起伏，麻烦再来一遍' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        gloss: '④ 对方：收到。信号 579，在上海，姓王，反过来问我',
      },
      {
