...
export const LESSONS: readonly Lesson[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '599 599=', gloss: '= 发成“划点点点划”，也就是 BT，用来分段', words: ['信号 599', '信号报告 599 分段'] },
  ...
  },
  {
    ...
    items: [
      ...
      { text: '{PARTNER} DE {CALLSIGN} = GM OM ES TNX FER CALL', gloss: '③ 我：叫对方、报自己（= 是分段的 BT），问好，谢谢他叫我', words: ['对方呼号', '这里是', '我的呼号', '分段', '早上好', '老朋友', '和', '谢谢', '为了', '呼叫'] },
      { text: 'UR RST 599 599 = QTH BEIJING = NAME LI = HW?', gloss: '④ 我：你的信号 599 599；我在北京，姓李；你呢？', words: ['你的', '信号报告', '读数', '读数', '分段', '位置', '北京', '分段', '名字', '李', '分段', '怎么样'] },
      { text: 'R R = GM ES TNX = UR RST 579 579 = QTH SHANGHAI = NAME WANG = HW?', gloss: '⑤ 他：收到收到，问好道谢；我的信号 579；他在上海，姓王；问我怎么样', words: ['收到', '收到', '分段', '早上好', '和', '谢谢', '分段', '你的', '信号报告', '读数', '读数', '分段', '位置', '上海', '分段', '名字', '王', '分段', '怎么样'] },
      { text: 'TNX FER NICE QSO = PSE QSL = 73 ES GL', gloss: '⑥ 我：聊得愉快，请寄卡片，73，祝顺利', words: ['谢谢', '为了', '愉快的', '通联', '分段', '请', '寄卡片', '分段', '致敬', '和', '好运'] },
      { text: 'QSL TU = 73 ES GL = {CALLSIGN} DE {PARTNER} SK', gloss: '⑦ 他：卡片说定了，谢谢；73，祝顺利；报出双方呼号，收摊', words: ['卡片', '谢谢', '分段', '致敬', '和', '好运', '分段', '我的呼号', '这里是', '对方呼号', '通联结束'] },
      { text: 'QSL VIA BUREAU = TNX = 73', gloss: '⑧ 我：卡片走卡片局，谢谢，73', words: ['卡片', '经由', '卡片局', '分段', '谢谢', '分段', '致敬'] },
      { text: 'PSE QRS = UR QSB = AGN PSE', gloss: '⑨ 他：请发慢些；我的信号有起伏；请再来一遍', words: ['请', '发慢些', '分段', '你的', '信号起伏', '分段', '再来一遍', '请'] },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        gloss: '③ 我：问好，报信号 599，说我在北京、姓李，再问他一串',
        words: [
          '对方呼号', '这里是', '我的呼号', '分段', '早上好', '老朋友', '分段', '谢谢', '为了', '你的', '呼叫',
          '分段', '你的', '信号报告', '读数', '读数', '分段', '位置', '北京', '北京',
          '分段', '名字', '李', '李', '分段', '怎么样', '对方呼号', '这里是', '我的呼号', '请回答',
        ],
      },
      {
        ...
        gloss: '④ 他：收到；我的信号 579；他在上海、姓王；回问我',
        words: [
          '收到', '我的呼号', '这里是', '对方呼号', '分段', '早上好', '老朋友', '李', '分段', '谢谢', '为了', '报告',
          '分段', '你的', '信号报告', '读数', '读数', '分段', '位置', '上海', '上海',
          '分段', '名字', '王', '王', '分段', '怎么样', '我的呼号', '这里是', '对方呼号', '请回答',
        ],
      },
      {
        ...
        words: [
          '收到', '收到', '分段', '谢谢', '王', '分段', '天气', '这里', '很好', '分段',
          '设备', 'IC7300', '功率', '100 瓦', '分段', '天线', '偶极天线', '分段',
          '请', '卡片', '经由', '卡片局', '分段', '谢谢', '为了', '愉快的', '通联', '和', '希望', '再见', '再',
          '分段', '致敬', '和', '好运', '对方呼号', '这里是', '我的呼号', '通联结束',
        ],
      },
      {
        ...
        words: [
          '收到', '收到', '分段', '卡片', '谢谢', '分段', '致敬', '和', '好运',
          '分段', '希望', '再见', '再', '分段', '我的呼号', '这里是', '对方呼号', '通联结束',
        ],
      },
    ],
  },
